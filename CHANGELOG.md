...
- Rebuilt Windows native-install ACL inheritance after interrupted deployments, verified critical task files before registration, and added task-result/log diagnostics with a 90-second startup allowance.
